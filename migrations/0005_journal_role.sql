...
INSERT OR IGNORE INTO accounts_new (id, user_id, role, alias, broker_name, mt5_login, api_key, api_secret, master_account_id, is_active, last_heartbeat, last_signal_at, signals_today, created_at)
