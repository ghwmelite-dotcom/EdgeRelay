...
const strategies = [
  {
    ...
    unique_params: [
      ...
      {"key":"ADX_PERIOD","label":"ADX Period","type":"int","default":14,"min":0,"max":50,"step":1,"tooltip":"ADX period for trend strength filter. 0 = disabled."},
      {"key":"ADX_MIN_STRENGTH","label":"Min ADX Strength","type":"double","default":20.0,"min":10.0,"max":50.0,"step":1.0,"tooltip":"Minimum ADX value to allow entry."},
      {"key":"SLOPE_BAR_COUNT","label":"Slope Lookback Bars","type":"int","default":3,"min":1,"max":10,"step":1,"tooltip":"Bars to compare for MA slope confirmation."},
      {"key":"USE_ATR_STOPS","label":"Use ATR Stops","type":"bool","default":false,"tooltip":"Use ATR-based dynamic SL/TP instead of fixed pips."},
      {"key":"ATR_STOP_PERIOD","label":"ATR Stop Period","type":"int","default":14,"min":5,"max":50,"step":1,"tooltip":"ATR period for dynamic stops."},
      {"key":"ATR_SL_MULT","label":"ATR SL Multiplier","type":"double","default":1.5,"min":0.5,"max":5.0,"step":0.1,"tooltip":"ATR multiplier for stop loss."},
      {"key":"ATR_TP_MULT","label":"ATR TP Multiplier","type":"double","default":2.0,"min":0.5,"max":5.0,"step":0.1,"tooltip":"ATR multiplier for take profit."},
      {"key":"RISK_PERCENT","label":"Risk % per Trade","type":"double","default":0,"min":0,"max":5.0,"step":0.25,"tooltip":"Risk percentage of balance per trade. 0 = use fixed lot."},
    ],
  },
  {
    ...
    unique_params: [
      ...
      {"key":"TIMEFRAME","label":"Timeframe","type":"enum","options":["PERIOD_M15","PERIOD_H1","PERIOD_H4","PERIOD_D1"],"labels":["M15","H1","H4","D1"],"default":"PERIOD_H1","tooltip":"Chart timeframe."},
      {"key":"BB_PERIOD","label":"Bollinger Band Period","type":"int","default":20,"min":10,"max":50,"step":1,"tooltip":"Period for Bollinger Bands confluence check."},
      {"key":"BB_DEVIATION","label":"Bollinger Deviation","type":"double","default":2.0,"min":1.0,"max":3.0,"step":0.5,"tooltip":"Standard deviation for Bollinger Bands."},
      {"key":"REQUIRE_BB_CONFLUENCE","label":"Require BB Confluence","type":"bool","default":true,"tooltip":"Only enter when price is at/beyond Bollinger Band."},
      {"key":"TREND_MA_PERIOD","label":"Trend MA Period","type":"int","default":200,"min":0,"max":500,"step":10,"tooltip":"EMA period for trend filter. 0 = disabled."},
      {"key":"TREND_MA_BUFFER","label":"Trend MA Buffer (ATR)","type":"double","default":1.0,"min":0.0,"max":3.0,"step":0.5,"tooltip":"Distance from MA in ATR units before blocking entry."},
      {"key":"ADX_PERIOD","label":"ADX Period","type":"int","default":14,"min":0,"max":50,"step":1,"tooltip":"ADX period. Blocks entry when ADX > threshold (too trendy for mean reversion). 0 = disabled."},
      {"key":"ADX_MIN_STRENGTH","label":"Max ADX for Entry","type":"double","default":30.0,"min":15.0,"max":50.0,"step":1.0,"tooltip":"Skip entry if ADX exceeds this (market trending too hard)."},
      {"key":"USE_ATR_STOPS","label":"Use ATR Stops","type":"bool","default":false,"tooltip":"Use ATR-based dynamic SL/TP instead of fixed pips."},
      {"key":"ATR_STOP_PERIOD","label":"ATR Stop Period","type":"int","default":14,"min":5,"max":50,"step":1,"tooltip":"ATR period for dynamic stops."},
      {"key":"ATR_SL_MULT","label":"ATR SL Multiplier","type":"double","default":1.5,"min":0.5,"max":5.0,"step":0.1,"tooltip":"ATR multiplier for stop loss."},
      {"key":"ATR_TP_MULT","label":"ATR TP Multiplier","type":"double","default":2.0,"min":0.5,"max":5.0,"step":0.1,"tooltip":"ATR multiplier for take profit."},
  ...
  },
  {
    ...
    unique_params: [
      ...
      {"key":"TIMEFRAME","label":"Timeframe","type":"enum","options":["PERIOD_M15","PERIOD_H1","PERIOD_H4","PERIOD_D1"],"labels":["M15","H1","H4","D1"],"default":"PERIOD_H1","tooltip":"Chart timeframe."},
      {"key":"ATR_RANGE_PERIOD","label":"ATR Range Period","type":"int","default":14,"min":5,"max":50,"step":1,"tooltip":"ATR period for range validation."},
      {"key":"MIN_RANGE_ATR_MULT","label":"Min Range (ATR x)","type":"double","default":0.5,"min":0.1,"max":2.0,"step":0.1,"tooltip":"Skip breakout if range < this × ATR (too tight)."},
      {"key":"MAX_RANGE_ATR_MULT","label":"Max Range (ATR x)","type":"double","default":3.0,"min":1.0,"max":5.0,"step":0.5,"tooltip":"Skip breakout if range > this × ATR (overextended)."},
      {"key":"ADX_PERIOD","label":"ADX Period","type":"int","default":14,"min":0,"max":50,"step":1,"tooltip":"ADX period for breakout confirmation. 0 = disabled."},
      {"key":"ADX_MIN_STRENGTH","label":"Min ADX Strength","type":"double","default":20.0,"min":10.0,"max":50.0,"step":1.0,"tooltip":"Minimum ADX value; also requires rising ADX."},
      {"key":"USE_ATR_STOPS","label":"Use ATR Stops","type":"bool","default":false,"tooltip":"Use ATR-based dynamic SL/TP instead of range-based stops."},
      {"key":"ATR_STOP_PERIOD","label":"ATR Stop Period","type":"int","default":14,"min":5,"max":50,"step":1,"tooltip":"ATR period for dynamic stops."},
      {"key":"ATR_SL_MULT","label":"ATR SL Multiplier","type":"double","default":1.5,"min":0.5,"max":5.0,"step":0.1,"tooltip":"ATR multiplier for stop loss."},
      {"key":"ATR_TP_MULT","label":"ATR TP Multiplier","type":"double","default":2.0,"min":0.5,"max":5.0,"step":0.1,"tooltip":"ATR multiplier for take profit."},
      {"key":"RISK_PERCENT","label":"Risk % per Trade","type":"double","default":0,"min":0,"max":5.0,"step":0.25,"tooltip":"Risk percentage of balance per trade. 0 = use fixed lot."},
  ...
  },
  {
    ...
    unique_params: [
      ...
      {"key":"ASIAN_START_HOUR","label":"Asian Start (UTC)","type":"int","default":0,"min":0,"max":6,"step":1,"tooltip":"Hour the Asian session starts for range calculation."},
      {"key":"ASIAN_END_HOUR","label":"Asian End (UTC)","type":"int","default":8,"min":4,"max":10,"step":1,"tooltip":"Hour the Asian session ends."},
      {"key":"USE_ASIAN_TP","label":"Use Asian Range TP","type":"bool","default":true,"tooltip":"Target Asian session high/low for take profit."},
      {"key":"AVG_SPREAD_BARS","label":"Avg Spread Bars","type":"int","default":50,"min":10,"max":200,"step":10,"tooltip":"Bars to average for spread spike detection."},
      {"key":"SPREAD_SPIKE_MULT","label":"Spread Spike Multiplier","type":"double","default":2.0,"min":1.5,"max":5.0,"step":0.5,"tooltip":"Block entry if spread > this × average spread."},
      {"key":"ADX_PERIOD","label":"ADX Period","type":"int","default":14,"min":0,"max":50,"step":1,"tooltip":"ADX period for momentum filter. 0 = disabled."},
      {"key":"ADX_MIN_STRENGTH","label":"Min ADX Strength","type":"double","default":20.0,"min":10.0,"max":50.0,"step":1.0,"tooltip":"Minimum ADX to confirm momentum."},
      {"key":"USE_ATR_STOPS","label":"Use ATR Stops","type":"bool","default":false,"tooltip":"Use ATR-based dynamic SL/TP instead of fixed pips."},
      {"key":"ATR_STOP_PERIOD","label":"ATR Stop Period","type":"int","default":14,"min":5,"max":50,"step":1,"tooltip":"ATR period for dynamic stops."},
      {"key":"ATR_SL_MULT","label":"ATR SL Multiplier","type":"double","default":1.5,"min":0.5,"max":5.0,"step":0.1,"tooltip":"ATR multiplier for stop loss."},
      {"key":"ATR_TP_MULT","label":"ATR TP Multiplier","type":"double","default":2.0,"min":0.5,"max":5.0,"step":0.1,"tooltip":"ATR multiplier for take profit."},
  ...
  },
  {
    ...
    unique_params: [
      ...
      {"key":"EMA_SLOPE_THRESHOLD","label":"EMA Slope Threshold","type":"double","default":0.0005,"min":0.0,"max":0.01,"step":0.0001,"tooltip":"Minimum EMA slope (price units) to confirm trend. 0 = disabled."},
      {"key":"EMA_SLOPE_BARS","label":"EMA Slope Bars","type":"int","default":3,"min":1,"max":10,"step":1,"tooltip":"Bars to compare for EMA slope measurement."},
      {"key":"ADX_PERIOD","label":"ADX Period (Higher TF)","type":"int","default":14,"min":0,"max":50,"step":1,"tooltip":"ADX on higher timeframe for trend strength. 0 = disabled."},
      {"key":"ADX_MIN_STRENGTH","label":"Min ADX Strength","type":"double","default":20.0,"min":10.0,"max":50.0,"step":1.0,"tooltip":"Minimum ADX to confirm trend strength."},
      {"key":"USE_ATR_STOPS","label":"Use ATR Stops","type":"bool","default":false,"tooltip":"Use ATR-based dynamic SL/TP on entry timeframe."},
      {"key":"ATR_STOP_PERIOD","label":"ATR Stop Period","type":"int","default":14,"min":5,"max":50,"step":1,"tooltip":"ATR period for dynamic stops."},
      {"key":"ATR_SL_MULT","label":"ATR SL Multiplier","type":"double","default":1.5,"min":0.5,"max":5.0,"step":0.1,"tooltip":"ATR multiplier for stop loss."},
      {"key":"ATR_TP_MULT","label":"ATR TP Multiplier","type":"double","default":2.0,"min":0.5,"max":5.0,"step":0.1,"tooltip":"ATR multiplier for take profit."},
      {"key":"RISK_PERCENT","label":"Risk % per Trade","type":"double","default":0,"min":0,"max":5.0,"step":0.25,"tooltip":"Risk percentage of balance per trade. 0 = use fixed lot."},
