...
const strategies = [
  ...
  },
  {
    ...
    unique_params: [
      ...
      {"key":"MIN_RANGE_PIPS","label":"Min Range Size (pips)","type":"int","default":15,"min":0,"max":100,"step":5,"tooltip":"Skip breakout if Asian range is smaller than this."},
      {"key":"MAX_RANGE_PIPS","label":"Max Range Size (pips)","type":"int","default":80,"min":0,"max":300,"step":10,"tooltip":"Skip breakout if Asian range is larger than this. 0 = no limit."},
      {"key":"ADX_PERIOD","label":"ADX Period","type":"int","default":14,"min":0,"max":50,"step":1,"tooltip":"ADX period for trend strength filter. 0 = disabled."},
      {"key":"ADX_MIN_STRENGTH","label":"Min ADX Strength","type":"double","default":20.0,"min":10.0,"max":50.0,"step":1.0,"tooltip":"Minimum ADX value to allow entry."},
      {"key":"USE_ATR_STOPS","label":"Use ATR Stops","type":"bool","default":false,"tooltip":"Use ATR-based dynamic SL/TP instead of range-based stops."},
      {"key":"ATR_STOP_PERIOD","label":"ATR Stop Period","type":"int","default":14,"min":5,"max":50,"step":1,"tooltip":"ATR period for dynamic stops."},
  ...
  },
  {
    ...
    unique_params: [
      ...
      {"key":"TIMEFRAME","label":"Timeframe","type":"enum","options":["PERIOD_M15","PERIOD_H1","PERIOD_H4","PERIOD_D1"],"labels":["M15","H1","H4","D1"],"default":"PERIOD_H1","tooltip":"Chart timeframe."},
      {"key":"ADX_PERIOD","label":"ADX Period","type":"int","default":14,"min":0,"max":50,"step":1,"tooltip":"ADX period. Blocks entry when ADX > threshold (too trendy for S/D). 0 = disabled."},
      {"key":"ADX_MIN_STRENGTH","label":"Max ADX for Entry","type":"double","default":30.0,"min":15.0,"max":50.0,"step":1.0,"tooltip":"Skip entry if ADX exceeds this (market trending too hard for S/D)."},
      {"key":"USE_ATR_STOPS","label":"Use ATR Stops","type":"bool","default":false,"tooltip":"Use ATR-based dynamic SL/TP instead of zone-based stops."},
      {"key":"ATR_STOP_PERIOD","label":"ATR Stop Period","type":"int","default":14,"min":5,"max":50,"step":1,"tooltip":"ATR period for dynamic stops and zone strength scoring."},
      {"key":"ATR_SL_MULT","label":"ATR SL Multiplier","type":"double","default":1.5,"min":0.5,"max":5.0,"step":0.1,"tooltip":"ATR multiplier for stop loss."},
      {"key":"ATR_TP_MULT","label":"ATR TP Multiplier","type":"double","default":2.0,"min":0.5,"max":5.0,"step":0.1,"tooltip":"ATR multiplier for take profit."},
      {"key":"RISK_PERCENT","label":"Risk % per Trade","type":"double","default":0,"min":0,"max":5.0,"step":0.25,"tooltip":"Risk percentage of balance per trade. 0 = use fixed lot."},
    ],
  },
  {
    ...
    unique_params: [
      ...
      {"key":"KELTNER_ATR_MULT","label":"Keltner ATR Multiplier","type":"double","default":1.5,"min":1.0,"max":3.0,"step":0.1,"tooltip":"ATR multiplier for Keltner Channel width. BB inside KC = true squeeze."},
      {"key":"TIMEFRAME","label":"Timeframe","type":"enum","options":["PERIOD_M15","PERIOD_H1","PERIOD_H4","PERIOD_D1"],"labels":["M15","H1","H4","D1"],"default":"PERIOD_H1","tooltip":"Chart timeframe."},
      {"key":"ADX_PERIOD","label":"ADX Period","type":"int","default":14,"min":0,"max":50,"step":1,"tooltip":"ADX period. Rising ADX confirms squeeze expansion. 0 = disabled."},
      {"key":"ADX_MIN_STRENGTH","label":"Min ADX Strength","type":"double","default":20.0,"min":10.0,"max":50.0,"step":1.0,"tooltip":"Minimum ADX value; also requires rising ADX."},
      {"key":"USE_ATR_STOPS","label":"Use ATR Stops","type":"bool","default":false,"tooltip":"Use ATR-based dynamic SL/TP instead of fixed pips."},
      {"key":"ATR_STOP_PERIOD","label":"ATR Stop Period","type":"int","default":14,"min":5,"max":50,"step":1,"tooltip":"ATR period for dynamic stops."},
      {"key":"ATR_SL_MULT","label":"ATR SL Multiplier","type":"double","default":1.5,"min":0.5,"max":5.0,"step":0.1,"tooltip":"ATR multiplier for stop loss."},
  ...
  },
  {
    ...
    unique_params: [
      ...
      {"key":"ADX_PERIOD","label":"ADX Period","type":"int","default":14,"min":0,"max":50,"step":1,"tooltip":"ADX period. Blocks new grid if trend too strong. 0 = disabled."},
      {"key":"ADX_MIN_STRENGTH","label":"Max ADX for Grid","type":"double","default":30.0,"min":15.0,"max":50.0,"step":1.0,"tooltip":"Skip new grid / stop adding levels if ADX exceeds this."},
      {"key":"USE_ATR_STOPS","label":"Use ATR Stops","type":"bool","default":false,"tooltip":"Use ATR-based per-level SL instead of fixed pips."},
      {"key":"ATR_STOP_PERIOD","label":"ATR Stop Period","type":"int","default":14,"min":5,"max":50,"step":1,"tooltip":"ATR period for per-level stop loss."},
      {"key":"ATR_SL_MULT","label":"ATR SL Multiplier","type":"double","default":1.5,"min":0.5,"max":5.0,"step":0.1,"tooltip":"ATR multiplier for stop loss."},
      {"key":"ATR_TP_MULT","label":"ATR TP Multiplier","type":"double","default":2.0,"min":0.5,"max":5.0,"step":0.1,"tooltip":"ATR multiplier (unused — grid manages TP via Grid TP)."},
      {"key":"RISK_PERCENT","label":"Risk % per Trade","type":"double","default":0,"min":0,"max":5.0,"step":0.25,"tooltip":"Risk percentage of balance per trade. 0 = use fixed lot."},
      {"key":"MAX_ACCOUNT_RISK","label":"Max Account Risk %","type":"double","default":15.0,"min":5.0,"max":50.0,"step":1.0,"tooltip":"Close all grid positions if floating loss exceeds this % of balance."},
    ],
  },
  {
    ...
    unique_params: [
      ...
      {"key":"COOLDOWN_BARS","label":"Cooldown Bars","type":"int","default":3,"min":1,"max":10,"step":1,"tooltip":"Bars to wait after entry before allowing new trades."},
      {"key":"MOMENTUM_PCT","label":"Momentum Close %","type":"double","default":70.0,"min":50.0,"max":90.0,"step":5.0,"tooltip":"Close must be within this % of candle high/low for momentum confirmation."},
      ...
      {"key":"ADX_PERIOD","label":"ADX Period","type":"int","default":14,"min":0,"max":50,"step":1,"tooltip":"ADX period for momentum confirmation. 0 = disabled."},
      {"key":"ADX_MIN_STRENGTH","label":"Min ADX Strength","type":"double","default":20.0,"min":10.0,"max":50.0,"step":1.0,"tooltip":"Minimum ADX to confirm spike momentum."},
      {"key":"USE_ATR_STOPS","label":"Use ATR Stops","type":"bool","default":false,"tooltip":"Use ATR-based dynamic SL/TP instead of spike-based stops."},
      {"key":"ATR_STOP_PERIOD","label":"ATR Stop Period","type":"int","default":14,"min":5,"max":50,"step":1,"tooltip":"ATR period for dynamic stops."},
      {"key":"ATR_SL_MULT","label":"ATR SL Multiplier","type":"double","default":1.5,"min":0.5,"max":5.0,"step":0.1,"tooltip":"ATR multiplier for stop loss."},
      {"key":"ATR_TP_MULT","label":"ATR TP Multiplier","type":"double","default":2.0,"min":0.5,"max":5.0,"step":0.1,"tooltip":"ATR multiplier for take profit."},
      {"key":"RISK_PERCENT","label":"Risk % per Trade","type":"double","default":0,"min":0,"max":5.0,"step":0.25,"tooltip":"Risk percentage of balance per trade. 0 = use fixed lot."},
